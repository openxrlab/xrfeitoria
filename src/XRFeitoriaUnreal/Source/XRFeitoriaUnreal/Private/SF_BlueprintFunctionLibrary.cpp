...
bool USF_BlueprintFunctionLibrary::FileExists(FString Path)
{
...
#if ENGINE_MAJOR_VERSION == 4
bool USF_BlueprintFunctionLibrary::GetStaticMeshVertexLocations(UStaticMeshComponent* Comp, int32 LodIndex, TArray<FVector>& VertexPositions)
{
...
EOcclusion USF_BlueprintFunctionLibrary::GetOcclusionFromHitResult(
...
bool USF_BlueprintFunctionLibrary::DetectInterOcclusionVertices(
	TArray<FVector> Vertices,
	ACameraActor* Camera,
	FName MeshName,
...
bool USF_BlueprintFunctionLibrary::DetectOcclusionMesh(
	UMeshComponent* Comp,
	ACameraActor* Camera,
	float& non_occlusion_rate,
	float& self_occlusion_rate,
...
)
{
	...
	{
		UE_LOG(LogSF, Error, TEXT("DetectOcclusionMesh: %s is not a valid mesh component."), *MeshName.ToString());
		return false;
	}
...
bool USF_BlueprintFunctionLibrary::DetectInterOcclusionSkeleton(
	USkeletalMeshComponent* Comp,
	ACameraActor* Camera,
	float& non_occlusion_rate,
	float& self_occlusion_rate,
